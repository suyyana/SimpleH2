...
class SimpleH2Server {
  ...
  get(path, handler, opts = {}) {
    this.tree.add(path, 'GET', applyOptionsToHandler(handler, opts));
  }
  ...
  post(path, handler, opts = {}) {
    this.tree.add(path, 'POST', applyOptionsToHandler(handler, opts));
  }
  ...
  put(path, handler, opts = {}) {
    this.tree.add(path, 'PUT', applyOptionsToHandler(handler, opts));
  }
  ...
  delete(path, handler, opts = {}) {
    this.tree.add(path, 'DELETE', applyOptionsToHandler(handler, opts));
  }
